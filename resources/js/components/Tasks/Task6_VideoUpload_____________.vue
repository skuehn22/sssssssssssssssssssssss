    ...
    <div class="container">
        <form v-if="!videoSaved && !savingVideo" @submit.prevent="submitForm" class="upload-form">
            <div class="form-group">
                ...
                <label class="btn btn-secondary d-block w-100" for="file" @click="clearError">Datei auswählen</label>

                <p v-if="video" class="mt-2"><b>Ausgewählte Datei:</b></p>
                ...
                if (response.data.status === 'success') {
                    ...
                    axios.get('/task/get-all-task', {
                        ...
                        .then(response => {
                            ...
                            if(count === 4){
                                this.message += ' Super. Ihr habt alle Dateien hochgeladen.';
