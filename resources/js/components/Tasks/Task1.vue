    ...
    <div class="container bg-white">
        ...
        <div class="row bg-white">
            <div class="col-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: transparent; font-weight: 700;">
                            <span>Tragt Euren Namen hier ein:</span>
                        </div>

                        <!-- Added form for teamname -->
                        <form @submit.prevent="submitForm">
                            <div class="form-group pt-1 pb-2">
                                <input id="teamname" v-model="teamname" type="text" class="form-control same-height" placeholder="Unser Teamname" maxlength="25">

                            </div>
                            <div class="d-flex justify-content-center pt-3 pb-3">
                                <br>
                                <button type="submit" class="btn btn-primary same-height-btn" style="width: 100%;  ">Speichern</button>
                            </div>
                ...
                <!--
                <div class="row justify-content-center pt-5" v-if="teamname !== ''">
                    <div class="d-flex justify-content-around col-md-6">
                        <button @click="goToOverview" class="btn btn-secondary">Zur Übersicht</button>
                        <button @click="goToTask2" class="btn btn-primary">
                            Aufgabe 2
