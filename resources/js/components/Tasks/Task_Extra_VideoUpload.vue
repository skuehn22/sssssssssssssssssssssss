<template>
    <div class="container">
        <div class="row  bg-white">
            <div class="col-12">
                <h2 v-if="!videoSaved && !savingVideo" class="text-center mb-4">Bild / Video Upload</h2>
                ...
                if (response.data.status === 'success') {
                    ...
                    axios.get('/task/get-all-task', {
                        ...
                        .then(response => {
                            ...
                            if(count === 4){
                                this.message += ' Ihr habt 4 von 4 Dateien hochgeladen!';
